...
int main()
{
    ...
    onegin.right_sorted = copy_array(onegin.original, onegin.n_lines); // stdrdup
...
/*
    ...
    onegin.left_sorted  = copy_pointers_array(onegin.original_lines, onegin.n_lines);
    onegin.right_sorted = copy_pointers_array(onegin.original_lines, onegin.n_lines);
